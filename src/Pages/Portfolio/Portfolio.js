                ...
                <Grid item xs={12} sm={6} md={4} lg={3}>
                    ...
                    <Card className='customCard' onClick={() => setProjectDialog(Projects)}>
                        <CardActionArea>
                            ...
                            <CardMedia className='customCard_image' image={Projects.images.length > 0 ? Projects.images[0] : defaultImageURL} title={Projects.title} />
            ...
            <DialogTitle onClose={()=> setProjectDialog(false)}>
                ...
                <DialogActions className='projectDialog_actions'>
                    {projectDialog?.links?.map((link => (
                        ...
                        <a key={link.link} href={link.link} target='_blank' rel='noopener noreferrer' className='projectDialog_icon'>{link.icon}</a>
                    )))}
                </DialogActions>
        </Dialog>
   </Grid>
